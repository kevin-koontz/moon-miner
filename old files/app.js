...
function activeResource() {
  resource += 10
  console.log('activeResource collected: ', resource)
  // We need a bonus calculate fn here 

  // FIXME this draw should happen in it's own function, not here
  let activeResourceElm = document.getElementById('resource')
  activeResourceElm.innerText = resource.toString()
